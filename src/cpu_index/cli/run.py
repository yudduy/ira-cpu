...
from cpu_index.collection import count_collector
from cpu_index.analysis import indexer
from cpu_index.classification import local_classifier
from cpu_index.output.exports import export_all_csvs
from cpu_index.output.report_generator import generate_full_report
...
def validate_sample():
    ...
    from cpu_index.classification import llm_validator
...
def generate_visualizations():
    ...
    from cpu_index.output.visualizations import (
        plot_cpu_timeseries,
