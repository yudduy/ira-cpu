...
from cpu_index.analysis.ablation_config import (
    VALIDATION_EVENTS,
    SUCCESS_CRITERIA,
    AblationPhase,
    AblationVariant,
...
from cpu_index.classification.local_classifier import ClassifierConfig
...
def run_single_ablation(
    ...
    """
    from cpu_index.classification.local_classifier import (
        classify_article,
        compute_cpu_classification,
        aggregate_classifications,
    )
    from cpu_index.analysis.normalizer import normalize_bbd_style
