...
from cpu_index.analysis import indexer
...
class TestBuildIndex:
    ...
    @patch("cpu_index.analysis.indexer.db_postgres.get_monthly_counts")
    @patch("cpu_index.analysis.indexer.db_postgres.get_classification_counts_by_month")
    @patch("cpu_index.analysis.indexer.db_postgres.save_index_value")
    def test_build_index_no_data(self, mock_save, mock_get_counts, mock_monthly):
    ...
    @patch("cpu_index.analysis.indexer.db_postgres.get_classification_counts_by_month")
    @patch("cpu_index.analysis.indexer.db_postgres.save_index_value")
    def test_build_index_success(self, mock_save, mock_get_counts, mock_monthly):
        """build_index should return success with data."""
        # Return empty from monthly_counts to use classification fallback
        mock_monthly.return_value = []
        mock_get_counts.return_value = [
            {
                "month": "2024-01",
    ...
    @patch("cpu_index.analysis.indexer.db_postgres.get_classification_counts_by_month")
    @patch("cpu_index.analysis.indexer.db_postgres.save_index_value")
    def test_build_index_saves_to_database(self, mock_save, mock_get_counts, mock_monthly):
    ...
    @patch("cpu_index.analysis.indexer.db_postgres.get_classification_counts_by_month")
    @patch("cpu_index.analysis.indexer.db_postgres.save_index_value")
    def test_build_index_no_save_option(self, mock_save, mock_get_counts, mock_monthly):
...
class TestBuildOutletLevelIndex:
    ...
    @patch("cpu_index.analysis.indexer.db_postgres.get_classification_counts_by_outlet")
    @patch("cpu_index.analysis.indexer.db_postgres.save_index_value")
...
class TestValidateAgainstEvents:
    ...
    @patch("cpu_index.analysis.indexer.db_postgres.get_index_values")
...
class TestLegacyCompatibility:
    ...
    @patch("cpu_index.analysis.indexer.db_postgres.get_monthly_counts")
    @patch("cpu_index.analysis.indexer.db_postgres.get_classification_counts_by_month")
    def test_calculate_raw_index_legacy(self, mock_get_counts, mock_monthly):
